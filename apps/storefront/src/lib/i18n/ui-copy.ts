...
export function toProductCardCopy(
  ...
  return {
    ...
    inStockShort: messages.common.inStockShort,
    outOfStock: messages.product.preorderBadge,
    outOfStockShort: messages.common.outOfStockShort,
    availableByOrder: messages.product.availableByOrderBadge,
    availableByOrderShort: messages.product.availableByOrderBadgeShort,
