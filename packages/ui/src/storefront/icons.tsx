...
/** Intrinsic SVG size before CSS — avoids 300×150 FOUC flash on refresh. */
function iconSvgProps(props: IconProps, defaultSize = 24): IconProps {
  return {
    width: defaultSize,
    height: defaultSize,
    ...props,
...
export function IconDelivery(props: IconProps) {
  ...
  return (
    <svg viewBox="0 0 128 128" aria-hidden="true" {...iconSvgProps(props)}>
      <defs>
        <mask
          id={maskId}
...
export function IconInstallmentPayment(props: IconProps) {
  ...
  return (
    <svg viewBox="0 0 512 563" aria-hidden="true" {...iconSvgProps(props)}>
      <defs>
        <mask
          id={maskId}
          maskUnits="userSpaceOnUse"
...
export function IconClick(props: IconProps) {
  ...
  return (
    <svg viewBox="0 0 48 48" aria-hidden="true" {...iconSvgProps(props)}>
      <defs>
        <mask
          id={maskId}
          maskUnits="userSpaceOnUse"
